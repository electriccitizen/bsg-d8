...
namespace Drupal\backstop_scenario\Form;
...
//    $form['#tree'] = TRUE;
    ...
    $form['label'] = [
      ...
      '#title' => $this->t('Label'),
      '#maxlength' => 255,
      '#default_value' => $this->entity->label() ?? 'Sample Page Title',
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\backstop_scenario\Entity\BackstopScenario::load',
      ],
...
//      '#open' => FALSE,
    ...
    $form['basic']['referenceUrl'] = [
      '#type' => 'textfield',
      '#title' => $this->t('referenceUrl'),
      '#default_value' => $this->entity->get('referenceUrl') ?? 'http://production.site/node/1',
...
//      '#multiple' => TRUE,
    ...
    $form['advanced']['misMatchThreshold'] = [
      '#type' => 'number',
    ...
    $form['advanced']['requireSameDimensions'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('requireSameDimenstion'),
